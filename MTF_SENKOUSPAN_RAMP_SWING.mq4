...
extern bool Is5mNotification = true;                   // 30m通知切り替え
extern bool Is15mNotification = true;                  // 1h通知切り替え
extern bool Is30mNotification = true;                  // 4h通知切り替え
extern bool Is60mNotification = true;                  // 1d通知切り替え
...
int OnInit()
{
   ...
   if (IsRamp)
   {
      ...
      calcSenkouSpanForOninit(240, true);
      calcSenkouSpanForOninit(1440, true);
   }
                ...
                const int &spread[])
{
   ...
   if (IsRamp)
   {
      ...
      calcSenkouSpan(240, isNewCandle);
      calcSenkouSpan(1440, isNewCandle);
   }
   if (IsCloud)
   {
